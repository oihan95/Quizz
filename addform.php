<?php
	echo('<br>');
	echo('<form enctype="multipart/form-data" name = "insertquestion" id="insertquestion" action="" method="post" onsubmit="gehitugaldera()" class="elegant-aero backgroundred">');
